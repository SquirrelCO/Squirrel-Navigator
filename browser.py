...
class Browser:
    ...
    def page_colorify(self, filtered_page):
        ...
        for page in filtered_page:
            ...
            if stripped_line != '':
                colored_page.append(Fore.MAGENTA+stripped_line
                                    if page.name == 'a'
                                    else stripped_line)
        return colored_page
    ...
    def usage():
        print(f'\n'
              f'{Fore.RED}'
              f'                    Squirrel-Navigator 0.0.2                 '
              f'{Fore.RESET}\n'
              f'{Fore.RESET}\n'
              f'          {Fore.BLUE}A private and secure Text-Based web browser\n'
              f'                            {Fore.RESET}(Usage: )\n'
              f'1:    >>> > {Fore.GREEN}Enter a URL\n'
              f'            {Fore.RESET}(type a website URL without https)\n'
              f'2:    >>> > {Fore.GREEN}back\n'
              f'            {Fore.RESET}(type back to go the last opened Page)\n'
              f'3:    >>> > {Fore.GREEN}exit{Fore.RESET}\n'
              f'            Text in {Fore.MAGENTA}magenta{Fore.RESET}'
              f' are hyperlinks on a website.'
              f'{Fore.RESET}\n'
              f'4:    >>> > {Fore.GREEN}use seARch! Terminal edition!!\n'
              f'            {Fore.RESET}se{Fore.RED}A{Fore.GREEN}R{Fore.RESET}ch{Fore.MAGENTA}!{Fore.RESET} for the CLI type: {Fore.MAGENTA}squirrelcom.github.io/seARchter{Fore.RESET}'
              f'{Fore.RESET}\n'
              f'5:    >>> > {Fore.YELLOW}Whats New!!\n'
              f'            {Fore.RESET}To see whats new type: {Fore.MAGENTA}squirrelcom.github.io/Squirrel-NavigatorNEW{Fore.RESET}'
              f'{Fore.RESET}\n'
              f'5:    >>> > {Fore.BLUE}Squirrel-Navigator Website\n'
              f'            {Fore.RESET}To goto to the homepage type: {Fore.MAGENTA}squirrelcom.github.io/SquirrelWebHome{Fore.RESET}'
              )
...
if __name__ == '__main__':
    ...
    while browse.seek_input() != 'exit':
        try:
            ...
            print(f'{Fore.RED}Unable to fetch {browse.user_input} (Squirrel-Navigator cannot locate that URL?)')
    deinit()
